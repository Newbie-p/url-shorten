    ...
    <div className="min-h-dvh bg-ink text-paper flex items-center justify-center px-4 py-14">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-muted text-sm mt-1.5">Login to manage your links and analytics.</p>
        </div>
        ...
        <p className="mt-6 text-sm text-muted text-center">
          New here? <Link to="/register" className="text-rust font-medium hover:underline">Create an account</Link>
        </p>
      </div>
    </div>
  );
